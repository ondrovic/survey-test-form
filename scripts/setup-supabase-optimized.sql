...
-- This includes both legacy tables and the new normalized structure
...
BEGIN
    ...
    RAISE NOTICE '   - Legacy and normalized schema coexistence';
    RAISE NOTICE '   - Complete indexing for performance';
    RAISE NOTICE '   - Migration functions ready';
    ...
    RAISE NOTICE '   3. Run data migrations if you have existing JSONB data';
END $$;