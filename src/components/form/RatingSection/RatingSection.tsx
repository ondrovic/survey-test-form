...
export const RatingSection: React.FC<RatingSectionProps> = ({
    ...
    const getButtonClasses = (option: any, isActive: boolean) => {
        ...
        if (isActive) {
            switch (option.color) {
                case 'success':
                    return clsx(baseClasses, 'bg-green-600 text-white focus:ring-green-500 shadow-lg');
                case 'warning':
                    return clsx(baseClasses, 'bg-yellow-600 text-white focus:ring-yellow-500 shadow-lg');
                case 'error':
                    return clsx(baseClasses, 'bg-red-600 text-white focus:ring-red-500 shadow-lg');
                default:
                    return clsx(baseClasses, 'bg-blue-600 text-white focus:ring-blue-500 shadow-lg');
            }
        } else {
            return clsx(
                baseClasses,
