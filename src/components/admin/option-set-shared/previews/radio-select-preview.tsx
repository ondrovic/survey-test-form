...
import { RADIO_OPTION_BUTTON_NAME, SELECT_OPTION_BUTTON_NAME, DEFAULT_FIELD_LABEL } from '@/constants/options-sets.constants';
...
export const RadioSelectPreview: React.FC<RadioSelectPreviewProps> = ({ data, type }) => {
    if (data.options.length === 0) {
        return (
            <div className="space-y-3">
                <h5 className="text-sm font-medium text-gray-700">{type === 'radio' ? RADIO_OPTION_BUTTON_NAME : SELECT_OPTION_BUTTON_NAME} Preview</h5>
