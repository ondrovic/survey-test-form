          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-4">
                <button
                  onClick={refresh}
                  className="bg-red-50 text-red-800 hover:bg-red-100 focus:ring-red-500 focus:ring-offset-red-50 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2"
                >
                  Try Again
                </button>
              </div>
