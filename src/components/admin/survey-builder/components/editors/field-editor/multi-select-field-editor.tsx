            ...
            <div className="space-y-6">
                ...
                {fieldTypes.includes('rating') && (
                    <div className="border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-white dark:bg-gray-800">
                        <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-3">Rating Scale</h4>
                        ...
                        {bulkUpdateOptions.ratingScaleId ? (
                            <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded">
                ...
                {(fieldTypes.includes('text') || fieldTypes.includes('email') || fieldTypes.includes('textarea') || fieldTypes.includes('number')) && (
                    <div className="border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-white dark:bg-gray-800">
                        <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-3">Placeholder Text</h4>
                        {selectedFields.length > 0 && (
                            <div className="mb-3">
                                <div className="text-xs text-gray-500 mb-2">
                ...
                {(fieldTypes.includes('text') || fieldTypes.includes('email') || fieldTypes.includes('textarea') || fieldTypes.includes('number')) && (
                    <div className="border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-white dark:bg-gray-800">
                        <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-3">Default Value</h4>
                        {selectedFields.length > 0 && (
                            <div className="mb-3">
                                <div className="text-xs text-gray-500 mb-2">
                ...
                <div className="border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-white dark:bg-gray-750">
                    <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-3">Required Field</h4>
                    {selectedFields.length > 0 && (
                        <div className="mb-3">
                            <div className="text-xs text-gray-500 mb-2">
            ...
            >
                ...
                <Modal.Body padding={false}>
                    <div className="flex-1 flex overflow-hidden h-full">
                        ...
                        <div className="w-1/2 border-r border-gray-200 dark:border-gray-600 p-6 overflow-y-auto bg-white dark:bg-gray-800">
                            <div className="mb-6">
                                <h3 className="font-semibold mb-4 text-gray-900 dark:text-white">Select Fields to Update</h3>
                            ...
                            <div className="space-y-4">
                                {config.sections.map(section => (
                                    <div key={section.id} className="border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-white dark:bg-gray-800">
                                            ...
                                            {section.fields.map(field => (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1">
                                                        <div className="font-medium text-sm text-gray-900 dark:text-gray-100">{field.label}</div>
                        ...
                        <div className="w-1/2 p-6 overflow-y-auto bg-white dark:bg-gray-800">
                            <div className="mb-6">
                                <h3 className="font-semibold mb-4 text-gray-900 dark:text-white">Bulk Update Options</h3>
                                {selectedFields.length === 0 ? (
                                    <p className="text-gray-500 dark:text-gray-400">Select fields from the left panel to configure bulk updates</p>
                                ) : (
                                    <>
                                        {/* Field Type Summary */}
