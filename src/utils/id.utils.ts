...
/**
 * Generate a UUID v4 compatible string that works across all browsers
 * Falls back to a random-based approach if crypto.randomUUID is not available
 */
export const generateUUID = (): string => {
  // Check if crypto.randomUUID is available (modern browsers, secure contexts)
